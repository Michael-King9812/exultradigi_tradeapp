...
include "conn.php";
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                          ...
                                          if($email == "" || $password == ""){
                                              ...
                                              $sql=$link->query("SELECT id,email,password,status FROM users WHERE email='$email' AND password= '$password'");
                                              ...
                                              if ($row['status'] == 1) {
                                                ...
                                                $msg = "You Account is currently deactivated.";
                                              }
                                            }
                                          }
				...
				<div class="form-container">
					<div>
						...
						<div class="row text-center">
							<h2 class="title-head hidden-xs"> <span>Login</span></h2>
                        ...
                        <?php if(isset($_GET['success']) && $msg == "") echo "<div style='padding:20px;background-color:#dce8f7;color:black'> You have successfully registered. Kindly login.</div class='btn btn-success'>" ."</br></br>";  ?>
							...
							<div class="form-group">
								...
								<p class="text-center">New member ? <a href="register.php">Register</a>
							</div>
