                    ...
                    <nav>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="btc.php">New Request</a></li>
                                      <li><a href="deposit.php">History</a></li>
...
embedder.parentNode.appendChild(s);
  ...
  <ul class="menu">
    ...
    <li><a href="#" class="selected" >Forex</a></li>
    <li><a href="stock.php" >Stock</a></li>
    <li><a href="crypto.php" >Cryptocurrency</a></li>
    <li><a href="indices.php" >Indices</a></li>
    <li><a href="cfd.php">Commodities</a></li>
   ...
   <li>
   <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModalLong">Sell</button></li>
   
   <li>
   <button class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg">Buy</button>
...
<label class="switch">
 <input  checked="checked"disabled="disabled"  id="toggle-trigger" type="checkbox" data-toggle="toggle">
  ...
  function toggleOffByInput() {
    $('#toggle-trigger').prop('checked', false).change()
	  ...
	  function relo(){
		  ...
		  function meta(){
		  window.location.href="metatrader.php";
		  }
</script>
                        ...
                        <ul class="notification-area pull-right">
                         ...
                         <div class="user-profile pull-right">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="withdrawal.php">Withdrawal</a>
                                <a class="dropdown-item" href="history.php" >History</a>
                                <a class="dropdown-item" href="history.php">Transactions</a>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <option value="EURGBP">EURGBP, Euro vs Great Britain Pound</option>
                        <option value="EURJPY">EURJPY, Euro vs Japanese Yen </option>
                        <option value="EURAUD">EURAUD, Euro vs Australian Dollar</option>
                        <option value="EURAUD">EURCAD, Euro vs Canadian Dollar</option>
                        ...
                        <option value="GBPJPY">GBPJPY, Great Britain Pound vs Japanese Yen</option>
                        <option value="GBPCAD">GBPCAD, Great Britain Pound vs Canadian Dollar</option>
                        <option value="GBPCHF">GBPCHF, Great Britain Pound vs Swiss Franc</option>
                        ...
                        <option value="NZDCAD">NZDCAD, New Zealand Dollar vs Canadian Dollar</option>
                        <option value="NZDCHF">NZDCHF, New Zealand Dollar vs Swiss Franc</option>
                        <option value="AUDUSD">AUDUSD, Australian Dollar vs US Dollar</option>
                        <option value="AUDJPY">AUDJPY, Australian Dollar vs Japanese Yen</option>
                        ...
                        <option value="CADJPY">CADJPY, Canadian Dollar vs Japanise Yen</option>
                        <option value="CADCHF">CADCHF, Canadian Dollar vs Swiss Franc</option>
                        <option value="CADNZD">CADNZD, Canadian Dollar vs New Zealand Dollar</option>
                        </select>
                      </div>
                    </div>
                  </div>
