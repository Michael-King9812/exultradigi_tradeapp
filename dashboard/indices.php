...
<body>
  ...
  <ul class="menu">
    ...
    <li><a href="stock.php" >Stock</a></li>
    <li><a href="crypto.php">Cryptocurrency</a></li>
    <li><a href="indices.php" class="selected">Indices</a></li>
    <li><a href="cfd.php">Commodities</a></li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <option value="AUS200">Australian 200 Index</option>
                        <option value="CA60">Canada 60 Index</option>
                        <option value="CHINA50">FTSE China A50 Index</option>
                        <option value="CHINAH">Hong Kong China H-shares Index</option>
                        <option value="DE40">Germany 40 Index</option>
                        <option value="ES35">Spain 35 Index</option>
                        <option value="F40">France 40 Index</option>
                        <option value="HK50">Hong Kong 50 Index</option>
                        <option value="JP225">Japan 225 Index</option>
                        <option value="MidDE50">Germany Mid 50 Index</option>
                        <option value="NETH25">Netherlands 25 Index</option>
                        <option value="NOR25">Norway 25 Index</option>
                        <option value="SA40">South Africa 40 Index</option>
                        <option value="SE30">Sweden 30 Index</option>
                        <option value="STOXX50">EU Stocks 50 Index</option>
                        <option value="SWI20">Switzerland 20 Index</option>
                        <option value="TecDE30">Germany Tech 30 Index</option>
                        <option value="UK100">UK 100 Index</option>
                        <option value="US2000">US Small Cap 2000 Index</option>
                        <option value="US30">US Wall Street 30 Index</option>
                        <option value="USTEC">US Tech 100 Index</option>
                        <option value="US500">US SPX 500 Index</option>
                        </select>
                      </div>
                    </div>
                  </div>
