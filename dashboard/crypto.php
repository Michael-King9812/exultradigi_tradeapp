...
<head>
    ...
    <title>ExUltraDigi | Cryptocurrency</title>
...
<body>
  ...
  <ul class="menu">
    ...
    <li><a href="index.php" >Forex</a></li>
    <li><a href="stock.php" >Stock</a></li>
    <li><a href="crypto.php" class="selected">Cryptocurrency</a></li>
    <li><a href="indices.php">Indices</a></li>
    <li><a href="cfd.php">Commodities</a></li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <option value="AAVEUSD">AAVEUSD, Aave vs US Dollar</option>
                        <option value="ALGOUSD">ALGOUSD, Algorand vs US Dollar</option>
                        <option value="ADAUSD">ADAUSD, Cardano vs US Dollar</option>
                        <option value="BATUSD">BATUSD, Basic Attention Token vs US Dollar</option>
                        <option value="BCHUSD">BCHUSD, Bitcoin Cash vs US Dollar</option>
                        <option value="BNBUSD">BNBUSD, Binance Coin vs US Dollar</option>
                        <option value="BTCUSD">BTCUSD, Bitcoin vs US Dollar</option>
                        <option value="CHZUSD">CHZUSD, Chiliz vs US Dollar</option>
                        <option value="CROUSD">CROUSD, Crypto.com Coin vs US Dollar</option>
                        <option value="DOGEUSD">DOGEUSD, Dogecoin vs US Dollar</option>
                        <option value="DOTUSD">DOTUSD, Polkadot vs US Dollar</option>
                        <option value="ENJUSD">ENJUSD, Enjin Coin vs US Dollar</option>
                        <option value="ETHUSD">ETHUSD, Ethereum vs US Dollar</option>
                        <option value="FTMUSD">FTMUSD, Fantom vs US Dollar</option>
                        <option value="FILUSD">FILUSD, Filecoin Token vs US Dollar</option>
                        <option value="GALAUSD">GALAUSD, Gala vs US Dollar</option>
                        <option value="HNTUSD">HNTUSD, Helium vs US Dollar</option>
                        <option value="LINAUSD">LINAUSD, Lina vs US Dollar</option>
                        <option value="LINKUSD">LINKUSD, Chainlink vs US Dollar</option>
                        <option value="LTCUSD">LTCUSD, Litecoin vs US Dollar</option>
                        <option value="MANAUSD">MANAUSD, Decentraland vs US Dollar</option>
                        <option value="MATICUSD">MATICUSD, Polygon vs US Dollar</option>
                        <option value="NEOUSD">NEOCUSD, NEO vs US Dollar</option>
                        <option value="SANDUSD">SANDCUSD, The Sandbox vs US Dollar</option>
                        <option value="SHIBDUSD">SHIBUSD, Shiba Inu vs US Dollar</option>
                        <option value="SNXUSD">SNXUSD, Synthetix Network Token vs US Dollar</option>
                        <option value="SOLUSD">SOLUSD, Solana vs US Dollar</option>
                        <option value="TRXUSD">TRXUSD, TRON vs US Dollar</option>
                        <option value="UNIUSD">UNIUSD, Uniswap vs US Dollar</option>
                        <option value="USDTUSD">USDTUSD, Tether vs US Dollar</option>
                        <option value="XLMUSD">XLMUSD, Stellar vs US Dollar</option>
    ...
    <!-- Button trigger modal -->
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Volume</label>
                        <input type="number" class="form-control"  name="amount" placeholder="Amounts" value="" step="any" required>
                      </div>
                    </div>
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
