...
// get user referal ID							
                                            ...
                                            $wth = "btc";
														...
														$sql = "INSERT INTO users (fname, lname, email, password, phone, wth) VALUES (?, ?, ?, ?, ?, ?)";
														 
														if($stmt = mysqli_prepare($link, $sql)){
															// Bind variables to the prepared statement as parameters
															mysqli_stmt_bind_param($stmt, "ssssss", $param_fname, $param_lname, $param_email, $param_password, $param_phone, $param_wth );
											...
											$param_wth  = $wth;
												...
												Welcome to Enoinvest.cash, we are happy to have you as a new member. This is a platform that helps its users acquire various cryptocurrecy. We provide incredible investment plans that is budget friendly and suites you!</p>
												</br>
...
<!-- Mirrored from coincrypto24.com/en/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Jun 2021 21:24:05 GMT -->
<head>
    ...
    <div class="wrapper">
        <div class="container-fluid user-auth">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					...
					<div>
						...
						<div class="row text-center">
							<h2 class="title-head hidden-xs">get <span>started</span></h2>
							 <p class="info-form">Open account for free and start trading the financial markets!</p>
						</div>
						<!-- Section Title Ends -->
						<!-- Form Starts -->
						<form method="post">
						<?php if($msg != "") echo "<div style='padding:20px;background-color:#dce8f7;color:black'> $msg</div class='btn btn-success'>" ."</br></br>";  ?>
							...
							<div class="form-group">
							  ...
							  <div class="form-group">
								<input type="text" class="form-control" name="lname" id="name" placeholder="Last Name" required>
							  </div>
				...
				<p class="text-center copyright-text">Copyright © ExUltraDigi All Rights Reserved</p>
				<!-- Copyright Text Ends -->
			</div>
		</div>
        <!-- Template JS Files -->
...
<script src="https://v3.txt.me/livechat/js/wrapper/2264096f-568f-4a68-bad4-24f77d358dad" async></script>
<noscript><a href="https://txt.me/reviews/2264096f-568f-4a68-bad4-24f77d358dad" rel="nofollow">Rate ExUltraDigi customer support</a>, powered by <a href="https://txt.me" rel="noopener nofollow" target="_blank">txt.me</a></noscript>
